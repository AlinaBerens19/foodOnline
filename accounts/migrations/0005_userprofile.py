...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('accounts', '0004_rename_date_login_user_date_joined_alter_user_role'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_pictures', models.ImageField(blank=True, null=True, upload_to='users/profile_pictures')),
